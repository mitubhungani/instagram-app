...
//     try {
//       // Fetch user's username from Firestore before creating a post
//       const userDocRef = doc(db, "users", currentUser.uid);
//       const userDoc = await getDoc(userDocRef);
//       const username = userDoc.exists() ? userDoc.data().username : "Anonymous";

//       // Creating the post with fetched username
//       const postWithUserId = {
//         ...posts,
//         userId: currentUser.uid,
//         timestamp: new Date(),
//         username: username, // Store username from Firestore
...
//             id: postDoc.id,
//             ...post,
//             username, // Add username to post data
//           };
//         })
//       );
...
//       if (user) {
//         getPosts(user); // Fetch posts for authenticated user
//       } else {
//         setAllPosts([]); // Clear posts if the user is not authenticated
//       }
//     });
...
//             {allPosts.map((ele) => (
//               <div key={ele.id} className="bg-white p-4 rounded-lg shadow-md">
//                 <p className="font-semibold">{ele.username || "Anonymous"}</p>
...
//                   <button
//                     className="border border-red-600 text-red-600 p-2 rounded hover:bg-red-600 hover:text-white transition duration-200"
//                     onClick={() => deletePosts(ele.id)}
//                   >
//                     Delete
//                   </button>
//                   <button
//                     className="border border-green-600 text-green-600 p-2 rounded hover:bg-green-600 hover:text-white transition duration-200"
